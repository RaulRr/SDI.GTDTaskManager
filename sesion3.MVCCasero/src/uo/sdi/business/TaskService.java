...
public interface TaskService {
	...
	public List<Task> findAllTasksByUserId(Long id)throws BusinessException;
	public Category findCategoryByName(String category, Long userId) throws BusinessException;
