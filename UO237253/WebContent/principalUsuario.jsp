...
<body>
	<div class="container">
		...
		<table class="table table-striped table-condensed">
			...
			<tr>
				<td><span class="glyphicon glyphicon-lock"></span> Es
					administrador:</td>
		...
		<c:if test="${user.getIsAdmin()==true}">
			<div class="alert alert-info">
				<a id="listarUsuarios_link_id" href="listarUsuarios"><span
					class="glyphicon glyphicon-list"></span> Listar Usuarios</a>
			</div>
		</c:if>
		<c:if test="${user.getIsAdmin()!=true}">
			<div class="alert alert-info">
				<a id="listarTareas_link_id" href="listarTareas"><span
					class="glyphicon glyphicon-list"></span> Listar Tareas</a>
			</div>
		</c:if>
		<br />
		<center>
			<a id="cerrarSesion_link_id" href="cerrarSesion?user=${user.login}"><span
				class="glyphicon glyphicon-off"></span> Cerrar sesión</a>
